...
Shader "Futile/BobMarleyDistortion" //Unlit Transparent Vertex Colored Additive 
{
Properties 
	{
...
textCoord.y /= _spriteRect.w - _spriteRect.y;
     ...
     half4 scr = half4(max(grabCol.x, -20.0/255.0), max(grabCol.y,200.0/255.0), max(grabCol.z,20.0/255.0), 1);
